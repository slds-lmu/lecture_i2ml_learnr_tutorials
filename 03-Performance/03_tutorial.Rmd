...
```{r, child="03_tutorial_01_Performance Estimation.Rmd"}
```

```{r, child="03_tutorial_02_Resampling.Rmd"}
```

```{r, child="03_tutorial_03_Nested Resampling.Rmd"}
```

```{r, child="03_tutorial_04_ROC and confusion matrix.Rmd"}
```
