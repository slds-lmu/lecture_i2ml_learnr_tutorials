---
title: "Introduction to Machine Learning - Supervised Classification"
output:
  learnr::tutorial:
    theme: cosmo
    css: css/custom.css
...
```{r, child="tutorial-supervised-classification-intro.Rmd"}
```

```{r, child="tutorial-supervised-classification-logistic.Rmd"}
```

```{r, child="tutorial-supervised-classification-more-methods.Rmd"}
```
