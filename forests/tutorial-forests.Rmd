---
title: "Introduction to Machine Learning - Bagging and Random Forests"
output:
  learnr::tutorial:
    theme: cosmo
    css: css/custom.css
...
```{r, child="tutorial-forests-bagging.Rmd"}
```

```{r, child="tutorial-forests-forests.Rmd"}
```

```{r, child="tutorial-forests-importance-discussion.Rmd"}
```
