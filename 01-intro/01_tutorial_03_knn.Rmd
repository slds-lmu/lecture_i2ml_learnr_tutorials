...
```{r knn-quiz2, echo=FALSE}
question("Which statements are true?",
  answer("The presence of irrelevant features haven't any effect on accuracy of k-NN."),
  answer("k-NN has no training-step and is a very local model.", correct = TRUE),
