---
title: "Introduction to Machine Learning - Day 2"
output:
  learnr::tutorial:
    theme: cosmo
    css: css/custom.css
...
```{r, child="02_tutorial_01_classification.Rmd"}
```

```{r, child="02_tutorial_02_logistic.Rmd"}
```

```{r, child="02_tutorial_03_classif_approaches.Rmd"}
```

```{r, child="02_tutorial_04_cultures.Rmd"}
```
