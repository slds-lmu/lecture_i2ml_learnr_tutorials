...
question("Which statements are true?",
  ...
  answer("The modeling culture is obsolete because the modeling culture is often better."),
  answer("In the algorithmic culture much effort is spend in how to get better in generalizing on new data.", correct = TRUE),
  answer("In the modeling culture much effort is spend in how to correctly model the true unknown (statistical) process.", correct = TRUE)
)
```
